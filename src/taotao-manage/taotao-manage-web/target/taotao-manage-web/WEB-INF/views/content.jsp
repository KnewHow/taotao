...
$(function(){
	...
	tree.tree({
		onClick : function(node){
			if(tree.tree("isLeaf",node.target)){//判断是否是叶子节点，如果是，根据id查询内容
...
var contentListToolbar = [{
    ...
    iconCls:'icon-add',
    handler:function(){
    	var node = $("#contentCategoryTree").tree("getSelected");//获取选中的节点
    	if(!node || !$("#contentCategoryTree").tree("isLeaf",node.target)){//如果是叶子节点，就打开新增的窗口
