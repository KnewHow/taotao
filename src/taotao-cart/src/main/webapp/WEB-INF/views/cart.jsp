...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
   ...
   <link rel="stylesheet" href="http://static.taotao.com:81/css/base.css">
   <link href="http://static.taotao.com:81/css/purchase.2012.css?v=201410141639" rel="stylesheet" type="text/css">
...
<div class="w w1 header clearfix">
	<div id="logo"><a href="http://www.taotao.com/"><img clstag="clickcart|keycount|xincart|logo" src="http://static.taotao.com:81/images/taotao-logo.gif" title="返回淘淘商城首页" alt="返回淘淘商城首页"></a></div>
...
<script type="text/javascript" src="http://static.taotao.com:81/js/base-v1.js"></script>
<!-- footer start -->
<jsp:include page="../commons/footer.jsp" />
<!-- footer end -->

<!-- 购物车相关业务 -->
<script type="text/javascript" src="http://static.taotao.com:81/js/cart.js"></script>
<script type="text/javascript" src="http://static.taotao.com:81/js/jquery.price_format.2.0.min.js"></script>
